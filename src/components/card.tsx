...
export default function CardComponent({
  ...
  return (
    <div className="w-full border-8 border-gray-800 rounded-3xl shadow-lg bg-gray-700 h-fit bg-opacity-80 backdrop-blur-lg text-gray-50 border-opacity-80 z-50 animate__animated animate__bounceIn py-8 lg:py-12 space-y-6 px-6 lg:px-16 mx-auto text-center">
